/**
 * Adapted from Common Paper's Mutual NDA Standard Terms Version 1.0
 * (https://github.com/CommonPaper/Mutual-NDA), licensed under CC BY 4.0
 * (https://creativecommons.org/licenses/by/4.0/).
 *
 * The original `<span class="coverpage_link">X</span>` cross-references (which
 * link back to the Cover Page's defined terms) are replaced here with
 * `{{token}}` placeholders that get substituted with the actual answers a
 * user enters, since this generator produces one combined, filled-in
 * document rather than a separate cover page + standard terms pair.
 */
...
/**
 * The Cover Page's introductory recital, kept verbatim from the source
 * template. It defines what the MNDA consists of and is still legally
 * meaningful in the combined document, so it is not dropped even though the
 * rest of the Cover Page's blank-form instructions are replaced with answers.
 */
export const COVER_PAGE_INTRO = `This Mutual Non-Disclosure Agreement (the “MNDA”) consists of: (1) this Cover Page (“**Cover Page**”) and (2) the Common Paper Mutual NDA Standard Terms Version 1.0 (“**Standard Terms**”) identical to those posted at [commonpaper.com/standards/mutual-nda/1.0](https://commonpaper.com/standards/mutual-nda/1.0). Any modifications of the Standard Terms should be made on the Cover Page, which will control over conflicts with the Standard Terms.`;

export const COVER_PAGE_FOOTER = `Common Paper Mutual Non-Disclosure Agreement (Version 1.0) free to use under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).`;
